<div class="header-title">
    <h3 class="font-weight-bold">LAUDO DESINFECÇÃO</h3>
</div>

<section class="text-center fs-18">
    <div class="mb-45">
        <h4 class="h4-custom">LOCAL:</h4>
        <p>Prestação de Serviços de Desinfecção de Caixa D’água na Empresa: {{ $documentData['socialname'] }}</p>
    </div>
    ...
    <div class="mb-45">
        ...
        <p><strong>CEP:</strong> {{ $documentData['cep'] }}</p>
    ...
    <div class="mb-45">
        ...
        <p>
            O objetivo da desinfecção é a destruição de microrganismo nocivos à saúde, com a finalidade de evitar infecções e doenças. A ação do Hipoclorito se deve a libertação de cloro “ativo”.
            O mecanismo de ação consiste no efeito de reação enzimática no interior da célula e produz desnaturação e inativação do ácido nucléico.
            O cloro ativo libertado que age, sobre as proteínas formando cloraminas que são dissolvidos na água.
        </p>
    </div>
