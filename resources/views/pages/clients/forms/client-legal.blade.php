...
<div class="grid md:grid-cols-2 gap-4">
    <label class="block">
        ...
        <div class="relative text-gray-500 focus-within:text-green-600">
            <input
                ...
                placeholder="Insira o CNPJ" id="documentNumberCnpj"
                name="documentNumber"
                required
                minlength="18"
    ...
    <label class="block">
        ...
        <input
            ...
            placeholder="Razão Social do cliente" id="companyNameCnpj"
            required
            minlength="3"
            maxlength="51"
            name="companyName" value="{{ old('companyName', $client->companyName) }}" />
    </label>
</div>
...
<div class="grid md:grid-cols-2 gap-4 mt-6">
    <label class="block">
        ...
        <input
            ...
            required
            minlength="3"
            placeholder="Nome da empresa/marca" id="fantasyNameCnpj" name="fantasyName"
    ...
    <label class="block">
        ...
        <input
            class="clearableInput block mt-3 w-full text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-green form-input"
            placeholder="Nome de identificação" id="identificationNameCnpj"
            required
            minlength="3"
...
<div>
    <label class="block text-2xl mt-6">
        ...
        <div class="grid md:grid-cols-7 sm:grid-cols-2 gap-4">
            <div class="col-span-1 mt-4 text-gray-500 focus-within:text-green-600">
                <input
                    ...
                    placeholder="CEP" id="zipcodeCnpj" name="zipcode"
                    required
                    minlength="10"
                    value="{{ old('zipcode', $client->zipcode) }}">
            </div>
            <input
                class="clearableInput col-span-5 mt-4 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-green form-input"
                placeholder="Rua/Avenida" id="streetCnpj" name="street"
                required
                minlength="3"
            ...
            <input
                ...
                placeholder="Numero" id="numberCnpj" name="number"
                required
        ...
        <div class="grid md:grid-cols-6 sm:grid-cols-2 gap-4">
            <input
                ...
                placeholder="Bairro" id="neighborhoodCnpj" name="neighborhood"
                required
                minlength="3"
            ...
            <input
                ...
                placeholder="Cidade" id="cityCnpj" name="city"
                required
                minlength="3"
            ...
            <input
                class="clearableInput mt-4 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-green form-input"
                placeholder="UF" id="stateCnpj" name="state"
                required
                minlength="2"
                maxlength="2"
            ...
            <input
                ...
                placeholder="Ponto de Referência" id="referencePointCnpj"
                name="referencePoint"
                minlength="3"
...
<label class="block text-2xl mt-5 mb-6">
    ...
    <textarea
        ...
        rows="3" placeholder="Escreva aqui" id="notesCnpj"
        minlength="3"
